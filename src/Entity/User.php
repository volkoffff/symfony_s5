...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\NotBlank(message: 'Vous devez avoir une adresse mail')]
     ...
     */
    #[ORM\Column]
    #[Assert\NotBlank(message: 'Vous devez avoir une mot de passe')]
    private ?string $password = null;

    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message: 'Vous devez avoir une prénom')]
